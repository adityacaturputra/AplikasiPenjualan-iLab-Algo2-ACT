...
Public Class FormDataPelanggan
    Sub KondisiAwal()
        ...
        Call Koneksi()
        Da = New OdbcDataAdapter("Select * From tabel_pelanggan", Conn)
        Ds = New DataSet
    ...
    Private Sub Button_Input_Click(sender As Object, e As EventArgs) Handles Button_Input.Click
        ...
        Else
            If TextBox1.Text = "" Or TextBox2.Text = "" Or TextBox3.Text = "" Or TextBox4.Text = "" Then
                MsgBox("Silahkan Isi Semua Field Data Pelanggan!")
            Else
                Call Koneksi()
                Dim InputData As String = "insert into tabel_pelanggan values('" & TextBox1.Text & "', '" & TextBox2.Text & "', '" & TextBox3.Text & "','" & TextBox4.Text & "')"
    ...
    Private Sub Button_Edit_Click(sender As Object, e As EventArgs) Handles Button_Edit.Click
        ...
        Else
            ...
            Else
                Call Koneksi()
                Dim UpdateData As String = "update tabel_pelanggan set namapelanggan='" & TextBox2.Text & "', alamatpelanggan='" & TextBox3.Text & "',teleponpelanggan='" & TextBox4.Text & "' where kodepelanggan='" & TextBox1.Text & "'"
    ...
    Private Sub TextBox1_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TextBox1.KeyPress
        If e.KeyChar = Chr(13) Then
            Call Koneksi()
            Cmd = New OdbcCommand("Select * From tabel_pelanggan where kodepelanggan='" & TextBox1.Text & "'", Conn)
    ...
    Private Sub Button_Hapus_Click(sender As Object, e As EventArgs) Handles Button_Hapus.Click
        ...
        Else
            ...
            Else
                Call Koneksi()
                Dim HapusData As String = "Delete from tabel_pelanggan where kodepelanggan='" & TextBox1.Text & "'"
